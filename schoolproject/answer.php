...
<?php
	...
	<form method="POST">
	<div id="q1">
			<h3>В каком году появился PHP</h3>
		<label for="radio">1994</label><input type="radio" name="year" value="a"><br>
		<label for="radio">1998</label><input type="radio" name="year" value="b"><br>
		<label for="radio">2007</label><input type="radio" name="year" value="c"><br><br>
		<input type="button" name="send1" onclick="viewdiv('q2')" href="javascript:void(0);" value="Далее">
	</div>
	<div id="q2">
		<h3>Разработчик PHP</h3>
		<label for="radio">Джеймс Гослинг</label><input type="radio" name="dev" value="a"><br>
		<label for="radio">Расмус Лердорф</label><input type="radio" name="dev" value="b"><br>
		<label for="radio">Гвидо ван Россум</label><input type="radio" name="dev" value="c"><br><br>
